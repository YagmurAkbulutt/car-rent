...
const Filter = ({options, name} : Props) => {
  ...
  // urlden daha önce seçilen seçeneği alıp select bileşeninin istediği forata çevirdik
  const selectedOpt = {
  ...
  return (
    <div className="w-fit">
      <Select defaultValue={selectedOpt} onChange={handleChange} options={options} className="text-black min-w-[100px]"/>
